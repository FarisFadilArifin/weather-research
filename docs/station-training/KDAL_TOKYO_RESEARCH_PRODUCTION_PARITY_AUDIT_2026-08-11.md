...
`pandas 3.0.5`, `numpy 2.5.1`, `requests 2.34.2`, `xarray 2026.7.0`,
`cfgrib 0.9.15.1`, `eccodes 2.47.0`, `ecmwflibs 0.7.0`,
`scikit-learn 1.9.0`, `joblib 1.5.3`, `xgboost 3.3.0`,
`lightgbm 4.7.0`, `catboost 1.2.10`, `mostlyrightmd 1.17.0`, and
`mostlyrightmd-weather 1.17.0`.

...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run station-stacking v14 curated-weather remaining-warmup stack.")
    ...
    parser.add_argument("--output-dir", type=Path, default=REPO_ROOT / "data/calibration/station_stacking_v14")
    parser.add_argument(
        "--climatology-normals",
        type=Path,
    ...
    for station in stations:
        ...
        if not args.skip_export:
            exported = export_station_model_weights(
                ...
                base_model_methods=BASE_MODEL_METHODS,
                stack_enabled=True,
                source_pipeline="scripts/run_station_stacking_v14.py",
            )

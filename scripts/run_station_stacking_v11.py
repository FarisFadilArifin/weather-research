...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run station-stacking v11 Huber base models with ridge stack.")
    ...
    parser.add_argument("--output-dir", type=Path, default=REPO_ROOT / "data/calibration/station_stacking_v11")
    parser.add_argument(
        "--climatology-normals",
        type=Path,
